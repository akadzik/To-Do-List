function addNewTask(title) {
    ...
    //Events - toogle and delete button
...
return  '<div class="input-group">' +
           ...
           '<span class="input-group-btn">' +
            ...
            '<input type="text" class="form-control" placeholder="Rename your task" value=" ' + title +' " >' +
...
function bindAddTaskEvents() {
    ...
    //On submit
    newTaskContainer.addEventListener('submit', function(event){
        event.preventDefault();
        
        var title = document.querySelector('.form-control').value;
        ...
        if (title) {
            ...
            alert('It is difficult to do nothing :) Type your task first, please.')
        }
    });
}
